...
const AllBookings = (props) => {
    ...
    const loadUsers = async () => {
        ...
        const result = await axios.post("http://localhost:9002/allbookings");
        setUser(result.data);
    };
    ...
    const markVisited = (e) =>
    {
        ...
        console.log(id)
        axios.post("http://localhost:9002/markvisited", {id:id})
        .then(res => {
                        ...
                        <tbody>
                            {users.map((user, index) => (
                                <tr>
                                    ...
                                    <td className="d-flex">
                                        <div className="pe-2">
                                        <button className="btn btn-primary mr-3"  onClick={markVisited} data-id={user._id}>Visited
                                            </button>
                                        </div>
                                    </td>
